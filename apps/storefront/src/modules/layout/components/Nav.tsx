        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 md:gap-4 flex-1 justify-end">
            ...
            >
              ...
              <span className="hidden lg:inline text-xs font-medium text-[var(--color-text-tertiary)] bg-[var(--color-bg-surface)] px-1.5 py-0.5 rounded border border-[var(--color-border-subtle)]">
                ⌘K
              </span>
            </button>
            ...
            <div className="hidden md:flex items-center gap-3 md:gap-4">
              ...
              <a
                ...
                className="text-[13px] font-bold text-[var(--color-text-primary)] hover:text-[var(--color-accent-gold)] bg-[var(--color-bg-surface-elevated)] hover:bg-[var(--color-bg-surface)] border border-[var(--color-border-subtle)] h-10 w-10 rounded-full transition-all duration-300 flex items-center justify-center shadow-xs cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-gold)]"
            ...
            <button
              ...
              className="text-[13px] font-bold text-[var(--color-bg-primary)] bg-[var(--color-text-primary)] hover:bg-[var(--color-accent-gold)] hover:text-[var(--color-bg-primary)] h-10 px-3.5 rounded-full transition-all duration-300 flex items-center gap-1.5 cursor-pointer shrink-0 shadow-md border border-[var(--color-border-subtle)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-gold)]"
