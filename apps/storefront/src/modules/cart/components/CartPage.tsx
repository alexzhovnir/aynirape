      ...
      {isEmpty ? (
        <div className="text-center py-16">
          ...
          <a
            ...
            className="inline-block bg-[#bdcd00] hover:bg-[#a6b400] text-stone-950 font-bold py-3.5 px-8 rounded-full transition-colors uppercase tracking-wider text-xs shadow-sm"
          >
            Continue Shopping
          </a>
        </div>
