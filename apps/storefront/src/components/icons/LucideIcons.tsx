...
export const ICON_PATHS: Record<IconName, React.ReactNode> = {
  ...
  "tree-pine": (
    <>
      <path d="m17 14 3 3.3a1 1 0 0 1-.7 1.7H4.7a1 1 0 0 1-.7-1.7L7 14h-.3a1 1 0 0 1-.7-1.7L9 9h-.2a1 1 0 0 1-.8-1.6L11.3 3a1 1 0 0 1 1.4 0L16 7.4a1 1 0 0 1-.8 1.6H15l3 3.3a1 1 0 0 1-.7 1.7H17z" />
      <path d="M12 22v-3" />
    </>
  ),
  wood: (
  ...
  "heart-handshake": (
    <>
      <path d="m11 17 2 2a1 1 0 0 0 1.42 0L19 14.42a4 4 0 0 0 0-5.66l-1.42-1.42a4 4 0 0 0-5.66 0l-.92.92-.92-.92a4 4 0 0 0-5.66 0L3 8.76a4 4 0 0 0 0 5.66l4.58 4.58a1 1 0 0 0 1.42 0L11 17Z" />
