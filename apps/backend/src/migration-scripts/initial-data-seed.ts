...
export default async function initial_data_seed({
  ...
  const productsToCreate = [
    // --- RAPÉ ---
    {
      ...
      images: [{ url: "/images/products/nukini-sansara-0.webp" }],
    ...
    },
    {
      title: "Huni Kuin",
      category_ids: [getCatId("Rapé")],
      thumbnail: "/images/products/huni-kuin-0.webp",
      images: [{ url: "/images/products/huni-kuin-0.webp" }],
    ...
    },
    {
      ...
      category_ids: [getCatId("Rapé")],
      thumbnail: "/images/products/yawanawa-tsunu-0.webp",
      images: [{ url: "/images/products/yawanawa-tsunu-0.webp" }],
    ...
    },
    {
      ...
      category_ids: [getCatId("Rapé")],
      thumbnail: "/images/products/spiritual-cleanse-0.webp",
      images: [{ url: "/images/products/spiritual-cleanse-0.webp" }],
    ...
    },
    {
      ...
      category_ids: [getCatId("Rapé")],
      thumbnail: "/images/products/forca-feminina-0.webp",
      images: [{ url: "/images/products/forca-feminina-0.webp" }],
